...
conn.sendButton(m.chat, `_${command}_`.trim(), `*◈•@${who.split("@s.whatsapp.net")[0]}*`, haha, [['🔄 ДАЛИЕ 🔄', `/${command}`]], fgif, { mentions: [who] })}
...
conn.sendButton(m.chat, `_${command}_`.trim(), `*◈•@${who.split("@s.whatsapp.net")[0]}*`, res2, [['🔄 ДАЛИЕ 🔄', `/${command}`]], fgif, { mentions: [who] })}

if (command == 'coffee') {
let haha = await conn.getFile(`https://coffee.alexflipnote.dev/random`)
await conn.reply(m.chat, global.wait, m)
conn.sendButton(m.chat, `_${command}_`.trim(), `*◈•@${who.split("@s.whatsapp.net")[0]}*`, haha.data, [['🔄 ДАЛИЕ 🔄', `/${command}`]], fgif, { mentions: [who] })}
